...
const regex = /- 20-point fetish checklists for anatomy \(NOTE: stating basic anatomy like bust size or body type to prevent LLM hallucination is completely fine and NOT slop\.\)/g;
